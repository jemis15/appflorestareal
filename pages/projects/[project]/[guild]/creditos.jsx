...
const LINKS_NAVIGATION = [
  ...
  { label: "Por finalizar", content: "POR_FINALIZAR" },
  { label: "Finalizados", content: "FINALIZADOS" },
  { label: "Retrasados", content: "RETRASADOS" },
];
...
export default function Creditos() {
  ...
  function links() {
    return LINKS_NAVIGATION.map((link, key) => (
      <BaseLink
        key={key}
        to={`/creditos?content=${link.content}`}
                    ...
                    .map((item, key) => {
                      ...
                      return (
                        <tr className="hover:bg-gray-50" key={key}>
                          ...
                          >
                            <div className="text-sm text-gray-800">12</div>
                          </td>
                          <td
                            className={`${
                              !isFirstItem && "border-t border-gray-300"
                          ...
                          >
                            <div className="text-sm text-gray-800">S/ 750</div>
                          </td>
                          <td
                            className={`${
                              !isFirstItem && "border-t border-gray-300"
